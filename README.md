...
http://localhost:8888/notebooks/OneDrive/%EB%B0%94%ED%83%95%20%ED%99%94%EB%A9%B4/%EC%A0%95%EC%84%9C%EC%9C%A4/python_summary.ipynb?
&nbsp;
...
>> 15
```
이 함수는 각 자리수를 각각 더하는 함수  ex) 1527 =1+5+2+7
